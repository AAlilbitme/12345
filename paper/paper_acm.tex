...
\textsc{Auth} is machine-checked in $C$ as \texttt{Forward1\_Requires\_Offer} (266 steps) and \texttt{Forward2\_Requires\_Forward1} (274 steps). It quantifies over a \emph{single adjacent pair} and never over the path or $N$; this locality is what makes it provable, and its failure for a generic signed rule is precisely the boundary reported above.
