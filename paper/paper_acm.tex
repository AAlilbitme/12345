...
\texttt{cltv\_blocks.spthy} & Pure CLTV block arithmetic (delta positivity) & 3 & 0 & 0.23\,s & Natural-numbers \\
\texttt{timeout.spthy} & Early-timeout race (T2b removed) & 0 & 1 & 0.06\,s & --- \\
\midrule
\multicolumn{2}{@{}l}{\emph{Distinct properties}} & \textbf{42} & \textbf{14} & & \\
\midrule
\texttt{multihop\_nhop.spthy} & \emph{Re-proof} of the above over the $N$-hop abstraction & 19 & 6 & 134.39\,s & Hashing, Signing, Multiset \\
\bottomrule
\end{tabular}
\end{table*}
