...
The linear-fact routing theory (\texttt{multihop\_nhop.spthy}): the HTLC is
...
All-$N$ routing safety ($\varphi$) & $\mathcal{A}$ (\texttt{multihop\_nhop}) & machine-checked (25 active lemmas, $\approx$103.5\,s) \\
